...
if (isset($_POST['btnRegistration'])) {
    ...
    $checkStudentEmail = $database->checkStudentEmail($email);
    ...
    if ($checkStudentEmail) {
        ...
        $studentRegistation = $database->registerStudent($firstName, $lastName, $email, $phoneNumber, $age);


        //check if the registration was successful
        if ($studentRegistation) {
